...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="text" style="height:25px; width:220px;" class="form-control" place-holder="Search"/>';
	
		var str = "<table><tr><td><span class='span_fix'>Search</span><td><td>";
...
//									btnClass = 'btn-primary' + (page < pages-1 ?
								...
								default:
									...
									btnClass = page === button ?
										classes.sPageButtonActive : ''; //Madhu
									break;
							}
